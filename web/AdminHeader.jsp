...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1><a href="index.html"><span>Welcome</span>(Admin)</a></h1>
      </div>
      <div class="clr"></div>
      ...
      <div class="menu_nav" style="width: 1200px;">
        <ul>
          ...
          <li><a href="SearchEmployee.jsp"><span>Search Employee</span></a></li>
          <li><a href="EmployeeList.jsp"><span>Employee List</span></a></li>
          <li><a href="ADAttendanceReport.jsp"><span>Attendance Report</span></a></li>
