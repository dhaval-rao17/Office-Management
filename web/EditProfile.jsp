<%-- 
    ...
    Created on : 7 Mar, 2024, 10:20:49 AM
    Author     : raodh
--%>
...
<div>
    <center>
        <span style="font-size: 30px;color: green;font-style: bold;">Edit Profile</span>
        <br>
        <br>
        <%
    ...
    out.println("<table width='800' border='3' cellpadding='10'>");
        ...
        out.println("<tr><td width='400'>Date of Birth</td><td><input type='date' name='dob'value="+db.rst.getString(1)+"></td></tr>");
